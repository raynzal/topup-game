  ...
  return (
    <section id="promo" className="py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div className="bg-gradient-to-r from-dark-800 via-dark-800/90 to-dark-800 border border-cyan-500/20 rounded-3xl p-8 md:p-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex items-center gap-3 mt-2">
                {[time.hours, time.minutes, time.seconds].map((val, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <div className="bg-dark-900 border border-cyan-500/30 rounded-xl px-4 py-2 min-w-[60px] text-center">
                      <span className="text-2xl font-bold text-cyan-400 font-mono">{String(val).padStart(2, '0')}</span>
            ...
            <div className="flex-shrink-0 text-center">
              <Link href={`/games/${flashGame.id}`}>
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-2xl bg-gradient-to-br from-dark-700 to-dark-800 border border-dark-700 flex flex-col items-center justify-center p-4 hover:border-cyan-500/30 transition group">
                  ...
                  <p className="text-cyan-400 text-xs font-bold mt-1">50% OFF</p>
                </div>
              </Link>
            </div>
          </div>
